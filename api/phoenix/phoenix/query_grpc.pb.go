...
const (
	Query_Params_FullMethodName          = "/phoenix.phoenix.Query/Params"
	Query_VirtualBlock_FullMethodName    = "/phoenix.phoenix.Query/VirtualBlock"
	Query_VirtualBlockAll_FullMethodName = "/phoenix.phoenix.Query/VirtualBlockAll"
)
...
func (c *queryClient) VirtualBlock(ctx context.Context, in *QueryGetVirtualBlockRequest, opts ...grpc.CallOption) (*QueryGetVirtualBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_VirtualBlock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) VirtualBlockAll(ctx context.Context, in *QueryAllVirtualBlockRequest, opts ...grpc.CallOption) (*QueryAllVirtualBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_VirtualBlockAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) VirtualBlock(context.Context, *QueryGetVirtualBlockRequest) (*QueryGetVirtualBlockResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VirtualBlock not implemented")
}
func (UnimplementedQueryServer) VirtualBlockAll(context.Context, *QueryAllVirtualBlockRequest) (*QueryAllVirtualBlockResponse, error) {
...
func _Query_VirtualBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_VirtualBlock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_VirtualBlockAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_VirtualBlockAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Query_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "phoenix/phoenix/query.proto",
}
